...
admin.site.site_header = "Jocko"
admin.site.site_title = "Jocko Admin Portal"
admin.site.index_title = "Jocko Admin"

# swagger
api_info = openapi.Info(
    title="Jocko API",
    default_version="v1",
    description="API documentation for Jocko App",
)
